    ...
    <div className="space-y-6">
      <div className="relative overflow-hidden rounded-lg border border-[#3b1d1d] bg-[linear-gradient(135deg,#161313_0%,#191414_58%,#241414_100%)] px-6 py-8 sm:px-8">
        ...
        <div className="relative z-10">
          <div className="mb-4 font-mono text-[11px] uppercase tracking-[0.38em] text-[#c9a84c]">
        ...
        <div className="pointer-events-none absolute bottom-4 right-4 select-none font-headline text-6xl text-white/5">
          ♠
        </div>
      </div>
      ...
      <section className="rounded-lg border border-white/10 bg-black/80 p-6 sm:p-8">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <div className="font-mono text-[11px] uppercase tracking-[0.28em] text-[#c9a84c]">
              Player Profile
            </div>
      ...
      <section className="rounded-lg border border-primary/20 bg-[linear-gradient(135deg,#120f10_0%,#171112_55%,#1e1214_100%)] p-6 sm:p-8">
        <div className="mb-6 flex items-start justify-between gap-4">
          <div className="flex items-center gap-4">
            <img
              src="https://api.dicebear.com/7.x/shapes/svg?seed=NeonDealers"
              alt="The Neon Dealers"
            ...
            <div>
              ...
              <p className="mt-2 max-w-2xl font-body text-sm uppercase tracking-[0.14em] text-primary/85">
                We ship fast, pitch sharp, and build for the judges first.
              </p>
            </div>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
          <div className="rounded-lg border border-white/10 bg-black/35 p-5">
            <div className="mb-3 font-mono text-[11px] uppercase tracking-[0.24em] text-white/45">
              Team Bio
            </div>
            <p className="font-body text-sm leading-7 text-white/75">
              Building an AI-powered project copilot for hackathon teams that helps with ideation,
              task planning, and presentation prep. We care about strong UX, clear storytelling,
              and shipping a demo that feels production-ready.
            </p>
          ...
          <div className="rounded-lg border border-white/10 bg-black/35 p-5">
            <div className="mb-4 font-mono text-[11px] uppercase tracking-[0.24em] text-white/45">
              Teammates
            </div>
            <div className="space-y-3">
              {teammates.map((teammate) => (
                <button
                  ...
                  className="flex w-full items-center gap-3 rounded-lg border border-white/10 bg-white/5 p-3 text-left transition-colors hover:border-primary/40 hover:bg-primary/10"
                >
                  <img
                    src={teammate.avatar}
                    alt={teammate.name}
      ...
      {isEditing && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <form
            onSubmit={saveEditor}
            className="relative z-10 w-full max-w-3xl rounded-lg border border-primary/30 bg-[#141011] p-6 shadow-[0_0_40px_rgba(122,16,36,0.18)]"
          >
            <div className="mb-6 flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 font-mono text-[11px] uppercase tracking-[0.24em] text-[#c9a84c]">
              ...
              <button
                type="button"
                onClick={() => setIsEditing(false)}
                className="rounded-full border border-white/10 bg-white/5 p-2 text-white/65 transition-colors hover:text-white"
              >
                <Icon name="close" />
              </button>
            </div>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              <div className="md:col-span-2">
                <label className="mb-2 block font-mono text-[11px] uppercase tracking-[0.22em] text-white/55">
                  Headline
                </label>
                <input
                  type="text"
                  ...
                  className="w-full rounded-lg border border-white/10 bg-black/40 px-4 py-3 font-body text-white placeholder:text-white/30 focus:border-primary focus:outline-none"
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-lg border border-white/10 bg-black/40 px-4 py-3 font-body text-white placeholder:text-white/30 focus:border-primary focus:outline-none"
                />
              </div>
            ...
            <div className="mt-6 flex justify-end gap-3 border-t border-white/10 pt-6">
              <button
                type="button"
                onClick={() => setIsEditing(false)}
                className="rounded border border-white/10 bg-white/5 px-5 py-2.5 font-body text-sm font-semibold text-white/70 transition-colors hover:bg-white/10 hover:text-white"
              >
                Cancel
              </button>
              <button
                type="submit"
                className="rounded border border-primary/50 bg-primary/10 px-5 py-2.5 font-body text-sm font-semibold text-primary transition-colors hover:bg-primary/20"
              >
                Save Changes
              </button>
            </div>
