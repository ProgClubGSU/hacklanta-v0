      ...
      <div className="mx-auto mt-10 max-w-md">
        ...
        <div className="mt-5 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <a
            ...
            className="group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-lg border border-[#5865F2]/30 bg-[#5865F2]/10 px-8 py-4 font-body text-sm font-bold tracking-[0.15em] text-white transition-all duration-300 hover:border-[#5865F2]/60 hover:bg-[#5865F2]/20 hover:shadow-[0_0_40px_rgba(88,101,242,0.3)] sm:w-auto"
          >
            <svg viewBox="0 0 24 24" className="h-5 w-5 fill-[#5865F2] transition-transform duration-300 group-hover:scale-110" aria-hidden="true">
            ...
            JOIN THE DISCORD
            <span className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-[#5865F2]/10 to-transparent transition-transform duration-700 group-hover:translate-x-full" />
          </a>
          <a
            href="https://instagram.com/progclubgsu"
            target="_blank"
            rel="noopener noreferrer"
            className="group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-lg border border-[#E1306C]/30 bg-[#E1306C]/10 px-8 py-4 font-body text-sm font-bold tracking-[0.15em] text-white transition-all duration-300 hover:border-[#E1306C]/60 hover:bg-[#E1306C]/20 hover:shadow-[0_0_40px_rgba(225,48,108,0.3)] sm:w-auto"
          >
            <svg viewBox="0 0 24 24" className="h-5 w-5 fill-[#E1306C] transition-transform duration-300 group-hover:scale-110" aria-hidden="true">
            ...
            FOLLOW ON INSTAGRAM
            <span className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-[#E1306C]/10 to-transparent transition-transform duration-700 group-hover:translate-x-full" />
          </a>
        </div>
      </div>
